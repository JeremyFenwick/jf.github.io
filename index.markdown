...
The largest challenge i've attempted overall - build an entire computer up to the operating system from nothing but NAND gates. A very fun project. The bulk of the project is written in the JACK language I wrote the compiler for, but for *that* I used good 'ol C#.
